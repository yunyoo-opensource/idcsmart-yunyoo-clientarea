							...
							<div class="mb-3 container">
								<div class="row align-items-end">
									<div class="p-0 col-auto mr-auto">
										<h1 class="text-primary">重置密码</h1>
									</div>
								</div>
							</div>
							<span class="clearfix"></span>
							<form id="registerForm" class="mb-0" method="post" action="/pwreset?action=email">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<div class="input-group-append">
											<button class="btn btn-primary" type="button" onclick="getCode(this,'reset_email_send','allow_email_forgetpwd_captcha')">获取验证码</button>
										</div>
									</div>
								...
								<div class="mt-4">
									<button id="registerBtn" type="submit" class="btn btn-block btn-primary"
										onclick="if(!beforeSubmit(this)) {return false;}">重置</button>
								</div>
							</form>
